...
class BackupServiceProvider extends AuthServiceProvider
{
    /**
    ...
    {
        $viewPath = base_path('resources/views/modules/backup');
    ...
    {
        $langPath = base_path('resources/lang/modules/backup');

        if (is_dir($langPath)) {
            $this->loadTranslationsFrom($langPath, 'backup');
        } else {
            $this->loadTranslationsFrom(__DIR__ .'/../Resources/lang/en', 'backup');
        }
    }
